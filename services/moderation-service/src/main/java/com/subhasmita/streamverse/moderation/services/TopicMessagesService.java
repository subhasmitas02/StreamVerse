...
public interface TopicMessagesService {
     ...
     * @throws com.subhasmita.streamverse.moderation.exceptions.NotFoundException if topic is not found
     */
     ...
     * @throws com.subhasmita.streamverse.moderation.exceptions.NotFoundException if message is not found
     */
